...
>
	<div class="flex flex-col justify-between">
		<div>
			...
			<div class="text-gray-700 mt-8 grid grid-cols-2 gap-2">
				<div><strong>Email</strong>: p.saidurga11@gmail.com</div>
				<div><strong>Phone</strong>: (+91) 9494570730</div>
				<div>
					<strong>Linkedin</strong>:
					<a class="text-indigo-500" href="https://www.linkedin.com/in/sai-durga/">Sai Durga</a>
				</div>
				<div>
					<strong>Github</strong>:
					<a class="text-indigo-500" href="https://github.com/saidurga11">Sai Durga</a>
				</div>
			</div>
		</div>
